...
namespace MVCWorldCup.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public GroupsController(MVCWorldCupContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Group != null ? 
                          ...
                          Problem("Entity set 'MVCWorldCupContext.Group'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVCWorldCupContext.Group'  is null.");
            }
            var @group = await _context.Group.FindAsync(id);
            if (@group != null)
            {
