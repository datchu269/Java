        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                    ...
                    DbContextOptions<RealEstateContext>>()))
            {
                ...
                {   //ServicePackage: 0 - gói 1 tuần, 1 - gói 1 tháng
                    new TransactionExcept { Time = DateTime.Parse("2022-12-29 15:20:00"), Day = 15, ServicePackage = "vang", TransactionId  = 1, UserId  = users.Single( a => a.FullName == "Michel").Id, ProductId  = products.Single( a => a.NameProduct == "Bán biệt thự hiện đại mới xây").Id},
                    new TransactionExcept { Time = DateTime.Parse("2022-12-29 16:20:00"), Day = 15, ServicePackage = "vang", TransactionId  = 2, UserId  = users.Single( a => a.FullName == "Recce Jame").Id, ProductId  = products.Single( a => a.NameProduct == "Bán chung cư Sunshine Riverside Tây Hồ").Id},
                    new TransactionExcept { Time = DateTime.Parse("2022-12-29 17:20:00"), Day = 15, ServicePackage = "vang", TransactionId  = 3, UserId  = users.Single( a => a.FullName == "Michel").Id, ProductId  = products.Single( a => a.NameProduct == "Bán căn hộ cao cấp Tây Hồ").Id},
                    new TransactionExcept { Time = DateTime.Parse("2022-12-29 18:20:00"), Day = 15, ServicePackage = "vang", TransactionId  = 4, UserId  = users.Single( a => a.FullName == "Recce Jame").Id, ProductId  = products.Single( a => a.NameProduct == "Cho thuê biệt thự hiện đại").Id},
                    new TransactionExcept { Time = DateTime.Parse("2022-12-29 22:20:00"), Day = 15, ServicePackage = "vang", TransactionId  = 5, UserId  = users.Single( a => a.FullName == "Recce Jame").Id, ProductId  = products.Single( a => a.NameProduct == "Cho thuê căn hộ, chung cư cao cấp").Id},
                };
